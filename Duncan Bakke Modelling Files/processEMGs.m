function lowEMG = processEMGs(model,title)
%processEMGs 
err = 0;
...
tInfo.Tstart = min(ParameterGroup(7).Parameter(7).data(2,1:4))-(ParameterGroup(1).Parameter(1).data(1)*0.005)-0.015;
...
[proEMG, ~, lowEMG] = processEMG(rawEMG, AnalogFrameRate);
